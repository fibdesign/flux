export const showFluxRoutes = (routes, res) => {
    const html = `
    <html>
    <head>
        <title>Flux Node Framework - Routes</title>
        <style>
            * {
                margin: 0;
                padding: 0;
    ...
    <body>
        ...
        `<tr><td colspan="4" class="empty">No routes defined</td></tr>`
            ...
            <footer>
                Generated by Flux Framework - ${new Date().toLocaleString()}
            </footer>
        </div>
    </body>
    </html>`;
